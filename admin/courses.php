        ...
        <div class="col-md-10">    
		    ...
		    <div class="container text-center mt-4 page-card">
                ...
                <form method="POST" action="process.php">
                    ...
                    <button class="btn btn-md mt-3 btn-primary" type="submit" name="addCourse">Add Course</button>
                </form>


                <h1 class="featurette-heading fw-bold mt-4 mb-5 text-color1">All <span class="text-color2">Courses</span></h1>
