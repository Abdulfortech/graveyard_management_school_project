  ...
  <main>
	...
	<section class="farko p-3 mt-5">
        ...
        <div class="col-md-5">    
            ...
            <h1 class="featurette-heading fw-bold mt-4 mb-5 text-color1">Edit <span class="text-color2">Faculty</span></h1>
            <form method="POST" action="process.php">
                ...
                <button class="w-100 btn btn-lg btn-primary" type="submit" name="editFaculty">Save Faculty</button>
            </form>
            </div>
        </div>
        </center>
